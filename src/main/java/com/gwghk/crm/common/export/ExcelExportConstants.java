...
public class ExcelExportConstants {
    //vo
    public static final String VO_F00000 = "F00000";        // 默认VO 名称
    ...
    public static final Integer TABLE_TYPE_3 = 3;                  // 类型:  2  两层动态表头
    ...
    public static final String TABLE_FLEXHEAD2 = "flexHead2";         // 动态列       懒得遍历计算了
    ...
    public static final String HEAD_COLUMNWIDTH = "columnWidth";                  // 表头名称(翻译)  必填
    ...
    public static final String HEAD_FORMULA = "formula";                          // 自定义 公式(每列指定不同的公式)
    //
    public static final String HEAD_FORMULA_SUM = "sum";                          // 自定义 公式(求和)
    public static final String HEAD_FORMULA_AVERAGE = "average";                  // 自定义 公式(平均值)
    public static final String HEAD_FORMULA_FORMULAEXT001 = "formulaExt001";      // 自定义 公式(formulaExt001 特殊公式)
    public static final String HEAD_FORMULA_FORMULAEXT002 = "formulaExt002";      // 自定义 公式(formulaExt002 特殊公式)
    //structureExt   总计  平均值 .....
    public static final String EXT_HEAD_SUM = "sum";            // 总计
    public static final String EXT_HEAD_AVERAGE = "average";            // 总计
    public static final String EXT_HEAD_MIXFORMULA = "mixFormula";            // 总计
    //data   数据源信息
